...
export const formatDomicilio = (domicilio: Record<string, any>): DomicilioDTO => {
    ...
    return {
        ...
        letra: domicilio.letra === '' ? null : String(domicilio.letra),
        piso: domicilio.piso === '' ? null : Number(domicilio.piso) || null,
        depto: domicilio.depto === '' ? null : String(domicilio.depto),
        monoblock: domicilio.monoblock === '' ? null : Number(domicilio.monoblock) || null,
