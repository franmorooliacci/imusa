...
export const responsableNoRnpSchema = yup
	.object({
		nombre: yup
			.string()
		...
		domicilioActual: domicilioSchema.required('Debe completar domicilio actual'),

		contacto: contactoSchema.required()
	})
	.required();

export type ResponsableNoRnpFormValues = yup.InferType<typeof responsableNoRnpSchema>;
