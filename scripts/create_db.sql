...
CREATE TABLE raza (
    ...
    nombre VARCHAR(255) NOT NULL,
    es_peligrosa TINYINT(1) NOT NULL,
    FOREIGN KEY (id_especie) REFERENCES especie (id)
);

INSERT INTO raza (id_especie, nombre, es_peligrosa)
VALUES
    (1, 'Caniche',0),
    (1, 'Chihuahua',0),
    (1, 'Cocker Spaniel Inglés',0),
    (1, 'Beagle',0),
    (1, 'Rottweiler',1),
    (1, 'Golden Retriever',0),
    (1, 'Gran Danés',0),
    (1, 'Mastín Inglés',0),
    (2, 'Singapura',0),
    (2, 'Devon Rex',0),
    (2,'Americano de pelo corto',0),
    (2, 'Siamés',0),
    (2, 'Grande de Noruega',0),
    (2, 'Maine Coon',0),
    (2, 'Savannah',0),
    (2, 'Chausie',0),
    (2, 'Burmés',0),
    (2, 'Tonquinés',0),
    (2, 'Manx',0),
    (2,'Exótico de pelo corto',0),
    (2, 'Abisinio',0),
    (1, 'Yorkshire Terrier',0),
    (1, 'Pomerania',0),
    (1, 'Shih Tzu',0),
    (1, 'Bichón Frisé',0),
    (1, 'Dachshund Miniatura',0),
    (2, 'Birmano',0),
    (2, 'Russian Blue',0),
    (2, 'Oriental de pelo corto',0),
    (2, 'Bengala',0),
    (2, 'British Shorthair',0),
    (1, 'Bulldog Francés',0),
    (1, 'Border Collie',0),
    (1, 'Schnauzer Mediano',0),
    (1, 'Basset Hound',0),
    (1, 'Cocker Americano',0),
    (2, 'Ragdoll',0),
    (2, 'Selkirk Rex',0),
    (2, 'Himalayo',0),
    (2, 'Ragamuffin',0),
    ...
    (1, 'Dálmata',0),
    (1, 'Husky Siberiano',0),
    (1, 'Doberman Pinscher',0),
    (1, 'Setter Irlandés',0),
    (1, 'Labrador Retriever',0),
    (2, 'Bosque de Noruega',0),
    (2, 'Maine Coon',0),
    (2, 'Savannah',0),
    (2, 'Pixie-Bob',0),
    (2, 'Highlander',0),
    (1, 'Mastín Napolitano',0),
    (1, 'San Bernardo',0),
    (1, 'Terranova',0),
    (1, 'Leonberger',0),
    (1, 'Mastín Tibetiano',0),
    (1, 'Indefinida',0),
    (2, 'Indefinida',0),
    (1, 'Pit Bull Terrier',1),
    (1, 'Staffordshire Bull Terrier',1),
...
CREATE TABLE animal (
    ...
    es_peligroso TINYINT(1) NOT NULL,
